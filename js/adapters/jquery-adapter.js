define([ 'jquery', 'bootstrap', 'jqueryScrollTo', 'datetimepicker', 'datetimepicker_lang_pt_BR', 'jqueryUI', 'nprogress', 'jqueryForm',  'jqueryInputMask', 'jqueryFormValidator',  
	'sweetAlert', 'metisMenu',	'nifty'], function($) {
